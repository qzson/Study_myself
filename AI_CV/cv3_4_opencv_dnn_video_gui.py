# 20-07-17
# 3-5. dnn 딥러닝 방식 Face Detection 동영상 GUI 프로그램
...
model_name = './AI_CV/source/res10_300x300_ssd_iter_140000.caffemodel'
prototxt_name = './AI_CV/source/deploy.prototxt.txt'
min_confidence = 0.5
...
def selectFile():
    file_name =  filedialog.askopenfilename(initialdir = "./AI_CV/source/opencv_dnn_202005/video",
